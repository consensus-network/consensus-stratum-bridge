...
import (
	...
	"github.com/GRinvestPOOL/consensus-stratum-bridge/src/consensusstratum"
	"gopkg.in/yaml.v2"
)
...
func main() {
	...
	cfg := consensusstratum.BridgeConfig{}
	...
	flag.StringVar(&cfg.RPCServer, "consensus", cfg.RPCServer, "address of the consensusd node, default `localhost:42110`")
	...
	if err := consensusstratum.ListenAndServe(cfg); err != nil {
		log.Println(err)
	}
}
