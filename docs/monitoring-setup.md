...
Go to the latest release ([v1.0.0](https://github.com/GRinvestPOOL/consensus-stratum-bridge/releases/tag/v1.0.0) at the time of writing) and download the source code. Download the zip archive for windows, tar.gz for everything else.
